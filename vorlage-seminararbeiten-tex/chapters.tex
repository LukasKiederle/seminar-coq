...
Mit Hilfe von VST inklusive CompCert wird versucht eine Art Stack aufzubauen, der von Maschinensprache über das Betriebssystem bis hin zu C-Programmcode formal verifiziert ist. Hierfür wird ein spezielles Coq-Framework namens Kami verwendet. Damit ist es möglich Hardware-Design formal zu beweisen. Diese Domain spezific Language (DSL) ist hauptsächlich inspiriert von \textbf{Bluespec} ihren RISC-V Open Source Cores.
