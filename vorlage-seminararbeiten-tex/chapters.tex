...
Die in orange dargestellte Komponenten bezüglich der \textbf{VST retargetable Seperation Logic} ergänzt die \textbf{program logic}. Zusätzlich können in diesem Schritt weitere \textbf{verified program analysis tools} integriert werden.\\
\\
Der nächste Teil in der Princeton Tool Chain ist der \textbf{verified Compiler CompCert}, welcher von INRIA entwickelt wurde. Sowohl CompCert, als auch die ganze VST ist open-source erhältlich auf GitHub unter \url{https://github.com/PrincetonUniversity/VST} und \url{https://github.com/PrincetonUniversity/VST/tree/master/compcert}. 
\begin{itemize}
	\item Übergang, was CompCert macht in einem Satz
\end{itemize}
...
\begin{itemize}
	\item Wie benutzt man nun praktisch die VST?
